...
const getWeatherTool = tool(
    ...
    },
    {
        ...
        schema: z.object({ // ! สำคัญ ต้องมี
            city: z
                .string()
                .describe("The name of the city, should be in English (e.g., Bangkok, Chiang Mai)."),
        }),
    }
)
...
export async function POST(req: NextRequest) {
    try {
        ...
        // ===============================================
        // TODO: const tools = [ xxx , yyy , zzz ]
        const tools = [getWeatherTool] // !add Tool
