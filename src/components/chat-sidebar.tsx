                                ...
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-colors text-xs whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 ${activeTab === tab.id
                                ...
                                {tabs.map((tab) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors text-sm ${activeTab === tab.id
                                                    ? 'bg-gray-400 dark:bg-gray-700 text-white font-medium'  // style สำหรับ active tab
                                                    : 'hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300'  // style สำหรับ inactive tab
                                                }`}
                                        >
...
// TODO : Main Chat Sidebar Component
// !============================================================================
